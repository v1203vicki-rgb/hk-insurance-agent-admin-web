...
const fallbackRows: TableRow[] = [
  ["张晓敏", "资料审核", "AIA_重疾险_产品小册子.pdf", "启用", "2026-05-20 10:28"],
  ["陈经理", "修改 Agent 规则", "高风险规则", "成功", "2026-05-20 09:31"],
...
export default async function AdminAuditLogsPage() {
  ...
  return (
    <PageShell title="操作日志" description="记录登录、审核、启用、禁用、导出和权限变更等关键事件">
      <InfoCard title="日志列表" description="MVP 可先保存 1 年，后续可接入更细粒度审计字段。">
        <DataTable headers={["操作人", "动作", "目标", "结果", "时间"]} rows={rows} gridTemplateColumns="0.9fr 1.2fr 1.5fr 0.7fr 1fr" />
      </InfoCard>
    </PageShell>
  );
}
